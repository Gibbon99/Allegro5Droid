...
//----------------------------------------------------------------------------------------------------------------------
{
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "optionsVideoCancelButton", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
...
//----------------------------------------------------------------------------------------------------------------------
{
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "guiOptionsMainVideoButton", GUI_COORD_TYPE_PERCENT, 50, 25, 65, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "guiOptionsMainAudioButton", GUI_COORD_TYPE_PERCENT, 50, 37, 65, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "guiOptionsMainGraphicsButton", GUI_COORD_TYPE_PERCENT, 50, 49, 65, 9);
	...
	as_guiCreateObject(GUI_OBJECT_BUTTON, "guiOptionsMainNetworkButton");
	as_guiAddObjectToScreen(GUI_OBJECT_BUTTON, "guiOptionsMainNetworkButton", "guiOptionsMain");
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "guiOptionsMainNetworkButton", GUI_COORD_TYPE_PERCENT, 50, 61, 65, 9);
	as_guiSetObjectLabel(GUI_OBJECT_BUTTON, "guiOptionsMainNetworkButton", GUI_LABEL_CENTER, gui_getString("guiOptionsMainNetworkButton"));
	as_guiSetObjectFunction(GUI_OBJECT_BUTTON, "guiOptionsMainNetworkButton", "as_guiHandleElementAction");
	as_guiSetReadyState(GUI_OBJECT_BUTTON, "guiOptionsMainNetworkButton", true);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "guiOptionsMainControlsButton", GUI_COORD_TYPE_PERCENT, 50, 73, 65, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "guiOptionsMainCancelButton", GUI_COORD_TYPE_PERCENT, 20, 90, 25, 9);
...
//------------------------------------------------------------
{
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutMoveNext", GUI_COORD_TYPE_PERCENT, 20, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutorialCancel", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutTransNext", GUI_COORD_TYPE_PERCENT, 20, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutTransCancel", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutTransGameNext", GUI_COORD_TYPE_PERCENT, 20, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutTransGameCancel", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
...
//	as_guiSetImageName("tut_lift", "tut_lift.bmp");
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutLiftNext", GUI_COORD_TYPE_PERCENT, 20, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutLiftCancel", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
...
//	as_guiSetImageName("tut_terminal", "tut_terminal.bmp");
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutTerminalNext", GUI_COORD_TYPE_PERCENT, 20, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutTerminalCancel", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
...
//	as_guiSetImageName("tut_healing", "tut_healing.bmp");
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutHealinglNext", GUI_COORD_TYPE_PERCENT, 20, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutHealingCancel", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "buttonTutTipsCancel", GUI_COORD_TYPE_PERCENT, 80, 90, 25, 9);
...
//----------------------------------------------------------------------------------------------------------------------
{
	...
	as_guiSetObjectPosition(GUI_OBJECT_LABEL, "mainScreenLabel", GUI_COORD_TYPE_PERCENT, 8, 19, 10, 10);
	as_guiSetObjectLabel(GUI_OBJECT_LABEL, "mainScreenLabel", GUI_LABEL_CENTER, gui_getString("mainScreenLabel"));
	as_guiSetObjectColor(GUI_OBJECT_LABEL, "mainScreenLabel", GUI_INACTIVE_COL, 250, 250, 200, 250);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "startGameButton", GUI_COORD_TYPE_PERCENT, 50, 25, 65, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "optionsButton", GUI_COORD_TYPE_PERCENT, 50, 40, 65, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "tutorialButton", GUI_COORD_TYPE_PERCENT, 50, 55, 65, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "briefingButton", GUI_COORD_TYPE_PERCENT, 50, 70, 65, 9);
	...
	as_guiSetObjectPosition(GUI_OBJECT_BUTTON, "exitGameButton", GUI_COORD_TYPE_PERCENT, 50, 85, 65, 9);
...
//	as_setupMessageBoxes();
	...
	as_guiSetObjectColor(GUI_OBJECT_BUTTON, "ALL", GUI_ACTIVE_COL, 50, 150, 150, 250);
	as_guiSetObjectColor(GUI_OBJECT_BUTTON, "ALL", GUI_INACTIVE_COL, 0, 50, 50, 250);

	as_guiSetObjectColor(GUI_OBJECT_CHECKBOX, "ALL", GUI_ACTIVE_COL, 50, 150, 150, 250);
	as_guiSetObjectColor(GUI_OBJECT_CHECKBOX, "ALL", GUI_INACTIVE_COL, 0, 50, 50, 250);

	as_guiSetObjectColor(GUI_OBJECT_TEXTBOX, "ALL", GUI_ACTIVE_COL, 50, 150, 150, 250);

	as_guiSetObjectColor(GUI_OBJECT_LABEL, "ALL", GUI_INACTIVE_COL, 250, 250, 200, 250);
