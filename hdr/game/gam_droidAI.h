...
extern	std::vector<_aiNode>		aiTree;
...
bool ai_addNode(int nodeType, std::string parentNode, std::string nodeName, functionPtr functionPtr);
...
void ai_processDroidAI (std::string levelName, float tickTime);
